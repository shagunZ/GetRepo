  ...
  return (
    <header className='header'>
        ...
        <div className="logo">
            ...
            <a href="https://www.github.com/shagunZ" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 512 512" xmlSpace="preserve" style={{position:"absolute",right:'22px',background:"white",borderRadius:'33px'}}>
        ...
        <div className="links">
            ...
            <Link href='/about/team'>Resource</Link>
